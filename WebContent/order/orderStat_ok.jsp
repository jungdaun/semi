		...
		<div id="orderStat_ok">
			...
			<!-- -------------------------------------------------------------- -->
				...
				<form action="orderStat_ok.jsp" name="orderStat">
					...
					<input type="radio" name="key" value="1">일간매출조회 <input
						type="radio" name="key" value="3">월간매출조회 <input
				...
				<%=y%>년
				<%=m%>월 <a href="orderStat_ok.jsp?key=<%=key%>&y=<%=y%>&m=<%=m + 1%>">다음</a><br>
				...
				<%=y%>년 <a href="orderStat_ok.jsp?key=<%=key%>&y=<%=y + 1%>&m=<%=m%>">다음</a><BR>
				<%
					break;
			...
			<div class="hGraph">
				<ul>
					...
					%>
					<li><span class="gTerm"><%=(i + 1)%> :</span><span class="gBar"
						style="width:<%=arr[i]%>%"><span> <%=arr[i]%></span></span></li>
