	...
	<div id="vocReWrite">
		...
		<form name="vocReWrite" action="vocReWrite_ok.jsp">
			...
			<input type="hidden" name="ref" value="<%=ref%>"> <input
				...
				type="hidden" name="turn" value="<%=turn%>">
			...
			<table>
				...
				<tr>
					<th>제목</th>
					<td colspan="3"><input type="text" name="title" size="45"
						value="Re:)<%=title%>"></td>
				</tr>
				<tr>
					<td colspan="4"><textarea rows="10" cols="45" name="content"></textarea>
					</td>
				</tr>

				<tr>
					<td colspan="4" align="center"><input type="submit"
						value="글쓰기"> <input type="reset" value="다시작성"></td>
				</tr>
